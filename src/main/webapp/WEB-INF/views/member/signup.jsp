							...
							<div class="aa-header-top-left">
								...
								<div class="aa-language">
									<div class="dropdown">
										<a class="btn dropdown-toggle" href="#" type="button"
											...
											aria-haspopup="true" aria-expanded="true" style="font-size:19px;"> 마이페이지 <span
											class="caret"></span>
										</a>
								...
								<div class="aa-currency">
									<div class="dropdown">
										<a class="btn dropdown-toggle" href="#" type="button"
											id="dropdownMenu1" data-toggle="dropdown"
											aria-haspopup="true" aria-expanded="true" style="font-size:19px;"> <i class=""></i>커뮤니티
				  ...
				  <div style="position: relative; right: -290px;" class="aa-myaccount-register" id="aa-myaccount">
					<div class="aa-myaccount-register">
					   ...
					   <p>  
						...
						<a href="/"><button type="submit" id="signup_btn"  name="signup_btn" style="position: relative; left: 230px; ">회원가입</button></a>
				...
				<div class="modal-content">
					<div class="modal-body">
						...
						<form class="aa-login-form" action="">
							<label for="">아이디<span>*</span></label> <input type="text"
								placeholder=""> <label for="">비밀번호<span>*</span></label>
